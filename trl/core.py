...
__all__ = ['flatten_dict', 'stack_dicts', 'add_suffix', 'pad_to_size_left', 'logprobs_from_logits', 'whiten',
...
def pad_to_size_left(tensor, size, dim=1, padding=50256, side='right'):
    """Pad tensor to size."""
    ...
    if t_size==size:
        ...
        if side=='right':
            ...
            return torch.nn.functional.pad(tensor, (size-t_size, 0), 'constant', padding)
